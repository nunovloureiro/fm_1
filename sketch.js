...
let mySketch = function(p) {
    ...
    p.gui = function() {
        ...
        if (go == 1 && menu == 0 && keyMenu == 0) {
            ...
            //stop button
            p.fill(0, 0, 255);
            p.rect(p.windowWidth / 2, p.windowHeight - p.windowHeight / 3.1, p.windowWidth / 1.7, p.windowWidth / 4.5);
    ...
    p.mousePressed = function() {
        ...
        if (go == 1 && menu == 0 && keyMenu == 0 && p.mouseX > p.windowWidth / 2 - p.windowWidth / 6 && p.mouseX < p.windowWidth / 2 + p.windowWidth / 6 && p.mouseY > p.windowHeight - p.windowHeight / 3.1 - textHeight && p.mouseY < p.windowHeight - p.windowHeight / 3.1 + textHeight) {
            if (audioSpigot == 1){
              audioSpigot = 0;
            } else {
              audioSpigot = 1;
